...
Popup.prototype=
{
	iframeIdName:'ifr_popup',initialize:function (config)
	{
		...
		this.color=
		{
			cColor:"#EEEEEE",bColor:"#FFFFFF",tColor:"#6B97C1",wColor:"#FFFFFF"
		};
		this.dropClass=null;
		this.someToHidden=[];
	...
	},build:function ()
	{
		...
		var close='<input type="image" id="dialogBoxClose" src="inc/close_off.gif" border="0" style="border:0px;" width="34" height="19" align="absmiddle" title="关闭"  onMouseMove=this.src="inc/close_on.gif" onMouseOut=this.src="inc/close_off.gif" />';
		...
		if(this.config.isHaveTitle)
		{
			mainBox+='<tr height="28" ><td background="inc/topbg.gif"><table style="-moz-user-select:none;height:28px;" width="100%" border="0" cellpadding="0" cellspacing="0" ><tr>'+'<td width="6" height="28"></td><td id="dialogBoxTitle" style="color:'+this.color.wColor+';font-size:14px;font-weight:bold;">'+this.info.title+'&nbsp;</td>'+'<td id="dialogClose" width="20" align="right" valign="top">'+close+'</td><td width="6"></td></tr></table></td></tr>'
		}else 
		{
	...
	{
		var confirm='<div style="width:100%;height:100%;text-align:center;"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">'+this.info.confirmCon+'</div><div style="margin:20px;"><input id="dialogOk" type="button" value=" ç¡®å® "/>&nbsp;<input id="dialogCancel" type="button" value=" åæ¶ "/></div></div>';
		var alert='<div style="width:100%;height:100%;text-align:center;"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">'+this.info.alertCon+'</div><div style="margin:20px;"><input id="dialogYES" type="button" value=" ç¡®å® "/></div></div>';
		var baseZIndex=10001+this.info.overlay*10;
