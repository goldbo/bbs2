...
<body>
<html:form action="/vcityTaskAction.do?action=saveTask" styleId="vcityTaskForm" >
<!-- 用于得到 动态生成的tr对象的各个ID -->
 <input type="hidden" id="randValue" name="randValue" value="1,2,3">
  <input type="hidden" id="surveyNum"  value="">
...
<%--          <td width="200" background="<%=baseURL %>/vcity/images/dh_wbg.jpg" class="b_white">2、配置体验模型</td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="68%"><input type="text" name="taskName" onChange="checkNameExist();" style=" width:60%" class="blueborderText" id="taskName">
          <span class="redFont12">*</span></td>
        </tr>
        <tr>
          <td height="30" class="tdr"><p><strong>有效期：</strong></p></td>
          <td><input type="text" name="taskBegin" id="taskBegin" onClick="new WdatePicker(this,'%Y-%M-%D',false,'whyGreen')" class="blueborderText" style="width:147px">
          ~
          <input type="text" name="taskEnd" id="taskEnd" onClick="new WdatePicker(this,'%Y-%M-%D',false,'whyGreen')" class="blueborderText" style="width:148px">
        </tr>
        <tr>
          <td height="30" class="tdr"><p><strong>任务类型：</strong></p></td>
          <td><input name="taskType" id="taskType1" type="radio" value="1" checked onClick="changeToAuto();" >
            自动任务

              <input type="radio" name="taskType" id="taskType2" value="2" onClick="changeToRenGong();">
          人工任务 <span class="redFont12">*</span></td>
        </tr>
        <tr>
          <td height="30" class="tdr"><p><strong>任务积分：</strong></p></td>
          <td><input type="text" id="credit" name="credit" style=" width:60%" class="blueborderText" >
          <span class="redFont12">*</span></td>
        </tr>
        <tr>
      	 <td height="30" class="tdr"><p><strong>参与人员：</strong></p></td>
          <td><div id="num" style="overflow: auto; width:60%; height:60px;  border:1px solid #A7CBE5;">
         <input type='checkbox' name='checkuser'   checked  value="wingotech"/>wingotech
         </div>
          <input type="button" name="Submit3" onClick="parent.ShowIframe('选择人员','<%=baseURL %>/shuaxuan.jsp',700,510);" class="btn_BS"  value="会员筛选">
<%--            <input type="button" name="Submit3" onClick="openDiv2('选择人员','shuaxuan.jsp',700,510)" class="btn_BS"  value="会员筛选">--%>
            <span class="redFont12">*</span></td>
        </tr>
        <tr>
          <td height="30" class="tdr"><p><strong>任务介绍：</strong></p></td>
          <td><textarea name="taskIntro" style="width:60%; height:60px;" ></textarea></td>
        </tr>
        <tr>
          <td height="50" colspan="2" align="center"><span id="autoButton">
          <input type="button" name="Submit4" value="下一步" onClick="toSub();" class="btn_BS">
&nbsp;&nbsp;
          </span><span id="rengongButton" style="display: none;"><input type="button" class="btn_BS" name="Submit4" value="下一步" onClick="toSurvey();"></span><input onClick="returnList();" type="button" name="Submit42" value=" 取消 " class="btn_BS"></td>
        </tr>
      </table>
...
<fieldset style="height:100%; padding:10px;">
  ...
  <tr>
    <td width="7"><img src="<%=baseURL %>/vcity/images/dh_left.jpg" width="7" height="43"></td>
    <td width="14"><img src="<%=baseURL %>/vcity/images/dh_wright.jpg" width="14" height="43"></td>
    <td width="200" background="<%=baseURL %>/vcity/images/dh_bbg.jpg" class="b_white">1、创建任务
    </td>
    <td width="14"><img src="<%=baseURL %>/vcity/images/dh_bleft.jpg" height="43"></td>
    <td width="200" class="b_blue">2、配置任务布骤<!--<br>
  <span class="wFont12">(
      必须设置一项任务内容
   ...
   <br>
      <table width="100%" border="0" id="childTab" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="200" align="center" class="grayFont14">操作</td>
        </tr>
        <tr id="child1" >
          <td height="25" align="center"><html:text property="value(1).subTaskIndex" style="width:30px" value="1" styleId="subTaskIndex1" styleClass="blueborderText"></html:text></td>
          <td align="center">
            <select name="value(1).subTaskType" id="type1" onChange="changeButton(1);">
              <option value="1">产品体验</option>
              <option value="2" selected>调查</option>
            </select>
        </td>
          <td><html:text property="value(1).subTaskDesc"  readonly="true"  style="width:100%" styleId="subTaskDesc1" styleClass="blueborderText"></html:text></td>
          <td align="center"><input type="button" id="bwj1" name="Submit2" value="选择问卷" class="btn_BS" onClick="document.getElementById('surveyNum').value =1; parent.ShowIframe('选择问卷','<%=baseURL %>/vcitySurveyAction.do?action=showVcitySureyList&flag=1',700,580)">
          					<%--<input type="button" class="btn_BS" style="display:none" id="bdc1" name="Submit2" value="选择产品体验" onClick="parent.ShowIframe('选择体验产品','<%=baseURL%>/vcityResourceAction.do?action=showVcityResourceList&flag=1',700,510);"> --%>
          					<input type="button" class="btn_BS" style="display:none" id="bdc1" name="Submit2" value="选择场景" onClick="parent.ShowIframe('选择场景','<%=baseURL%>/scene.do?option=doGetTree&flag=1&isManual=false',300,400);">
         <input type="hidden" id="subTaskResId1" name="value(1).subTaskResId">
         <input type="hidden" id="subTaskURL1" name="value(1).subTaskURL">
          <input type="button" name="Submit22" value=" 删 除" class="btn_BS" onClick="removeTaskChild(1);"></td>
        </tr>
        <tr id="child2">
          <td height="25" align="center" ><html:text property="value(2).subTaskIndex" style="width:30px" value="2" styleId="subTaskIndex2" styleClass="blueborderText"></html:text></td>
          <td align="center">
            <select name="value(2).subTaskType" id="type2" onChange="changeButton(2);">
              <option value="1">产品体验</option>
               <option value="2" selected>调查</option>
            </select>
        </td>
          <td><html:text property="value(2).subTaskDesc" readonly="true"  style="width:100%" styleId="subTaskDesc2" styleClass="blueborderText"></html:text></td>
          <td align="center"><input type="button" id="bwj2" name="Submit2" value="选择问卷" class="btn_BS" onClick="document.getElementById('surveyNum').value =2;parent.ShowIframe('选择问卷','<%=baseURL %>/vcitySurveyAction.do?action=showVcitySureyList&flag=2',700,580)"><input type="button" style="display:none" id="bdc2" class="btn_BS" name="Submit2" value="选择场景" onClick="parent.ShowIframe('选择场景','<%=baseURL%>/scene.do?option=doGetTree&flag=2&isManual=false',300,400);">
          <input type="hidden" id="subTaskResId2" name="value(2).subTaskResId">
          <input type="hidden" id="subTaskURL2" name="value(2).subTaskURL">
          <input type="button" name="Submit22" value=" 删除 " class="btn_BS" onClick="removeTaskChild(2);"></td>
        </tr>
        <tr id="child3">
          <td height="25" align="center"><html:text property="value(3).subTaskIndex" style="width:30px" value="3" styleId="subTaskIndex3" styleClass="blueborderText"></html:text></td>
          <td align="center">
            <select name="value(3).subTaskType" id="type3" onChange="changeButton(3);">
              <option value="1">产品体验</option>
			 <option value="2" selected>调查</option>
            </select>
        </td>
          <td><html:text property="value(3).subTaskDesc"  readonly="true"  style="width:100%" styleId="subTaskDesc3" styleClass="blueborderText"></html:text></td>
          <td align="center"><input type="button" id="bwj3" name="Submit2" value="选择问卷" class="btn_BS" onClick="document.getElementById('surveyNum').value =3;parent.ShowIframe('选择问卷','<%=baseURL %>/vcitySurveyAction.do?action=showVcitySureyList&flag=3',700,580)"><input type="button" style="display:none" id="bdc3" class="btn_BS" name="Submit2" value="选择场景" onClick="parent.ShowIframe('选择场景','<%=baseURL%>/scene.do?option=doGetTree&flag=3&isManual=false',300,400);">
        	 <input type="hidden" id="subTaskResId3" name="value(3).subTaskResId">
         	<input type="hidden" id="subTaskURL3" name="value(3).subTaskURL">
          <input type="button" name="Submit22" value=" 删除 " class="btn_BS" onClick="removeTaskChild(3);"></td>
        </tr>
    </table>
      <br>
    <input type="button" value="添加一项" onClick="createTaskChild();" class="btn_BS" />
	<div style=" text-align:center; padding-top:10px;">
	<input type="button" name="Submit42" value="上一步" onClick="toMain();" class="btn_BS">
	&nbsp;&nbsp;
	  <input type="button" name="Submit42" value="下一步" onClick="toPreview();" class="btn_BS">
&nbsp;&nbsp;
<input type="button" onClick="returnList();" name="Submit42" value=" 取消 " class="btn_BS">
	</div>
</fieldset>
</td></tr></table>
...
<fieldset style="height:100%; padding:10px;">
  ...
  <tr>
    ...
    <td width="14"><img src="<%=baseURL %>/vcity/images/dh_wright.jpg" width="14" height="43"></td>
    <td width="200" class="b_white">2、配置任务布骤</td>
	<td width="14"><img src="<%=baseURL %>/vcity/images/dh_bleft.jpg" height="43"></td>
...
&nbsp;&nbsp;
<input type="button" name="Submit42" value=" 确认发布 " class="btn_BS" onClick="publish('<%=baseURL %>/vcityTaskAction.do?action=saveTask');">
	</div>
</fieldset>
</td></tr></table>
...
<fieldset style="height:100%; padding:10px;">
  ...
  <tr>
    ...
    <td width="200" background="<%=baseURL %>/vcity/images/dh_bbg.jpg" class="b_white">1、创建任务</td>
    <td width="14"><img src="<%=baseURL %>/vcity/images/dh_bleft.jpg" height="43"></td>
    <td width="200" background="<%=baseURL %>/vcity/images/dh_wbg.jpg" class="b_blue">2、配置体验模型</td>
	<td width="14"><img src="<%=baseURL %>/vcity/images/dh_bright.jpg" width="14" height="43"></td>
	<td width="200" background="<%=baseURL %>/vcity/images/dh_wbg.jpg" class="b_white">2、配置调查问卷</td>
	<td width="14"><img src="<%=baseURL %>/vcity/images/dh_wright.jpg" width="14" height="43"></td>
	<td width="200" background="<%=baseURL %>/vcity/images/dh_wbg.jpg" class="b_white">3、任务预览</td>
  ...
  <tr>
    ...
    <td width="79%">
      <input type="button" name="Submit5" value="选择模型" class="btn_BS" onClick="parent.ShowIframe('选择体验产品','<%=baseURL%>/vcityResourceAction.do?action=showVcityResourceList&flag=1&manual=1',700,580);">
      <input type="button" name="Submit5" value="选择模型" class="btn_BS" onClick="parent.ShowIframe('选择场景','<%=baseURL%>/scene.do?option=doGetTree&flag=2&isManual=true',300,400);"></td>
    <td width="14%">&nbsp;</td>
    </tr>
		<tbody id="testModel">
		</tbody>
...
<fieldset style="height:100%; padding:10px;">
  ...
  <tr>
    ...
    <td width="14"><img src="<%=baseURL %>/vcity/images/dh_wright.jpg" width="14" height="43"></td>
    <td width="200" background="<%=baseURL %>/vcity/images/dh_bbg.jpg" class="b_white">1、创建任务</td>
    <td width="14"><img src="<%=baseURL %>/vcity/images/dh_bleft.jpg" width="14" height="43"></td>
    <%--<td width="200" background="<%=baseURL %>/vcity/images/dh_wbg.jpg" class="b_white">2、配置体验模型</td>
	<td width="14"><img src="<%=baseURL %>/vcity/images/dh_bleft.jpg" height="43"></td>
...
<input type="button" name="Submit42" value="下一步" class="btn_BS" onClick="toRenGongView();">
	&nbsp;&nbsp;<input type="button" name="Submit422" class="btn_BS" onClick="returnList();" value=" 取消 ">
	</div>
</fieldset>
</td></tr></table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="33%" height="50" class="tdr"><img src="<%=baseURL %>/vcity/images/ts.jpg" width="46" height="43"></td>
    <td width="67%"><strong class="greenFont18" id="p1"></strong></td>
  </tr>
  <tr>
...
function checkNameExist(){
 var username = '${jsprun_userss}';
	...
	vcityTaskService.checkTaskExistByName(null,taskName,username,function exist(str){
		if(str=="1"){
			alert("任务名称已经存在！");
...
function changeButton(num){
	...
	if(v=='1'){
		...
		document.getElementById("bdc"+num).style.display='';
	}if(v=='2'){
		document.getElementById("bdc"+num).style.display='none';
...
function checkToSub(){
	var taskName = document.getElementById("taskName").value;
	//var users = document.getElementById("num").innerHTML;
...
function checkToPreview(){
	var test = document.getElementById('randValue').value;
		if(test!=""){
			var subNames = test.split(",");
			var desc = "";
			for(var i=0;i<subNames.length;i++){
				 desc += document.getElementById("subTaskDesc"+subNames[i]).value;
			} 
			if(desc==""){
				alert("至少添加一项子任务！");
				return false;
...
function createTaskChild(){
	...
	if(randValue!=""){
		document.getElementById('randValue').value = randValue+","+rand;
          ...
          str +="<td height='25' align='center'><input type='text' name='value("+ rand +").subTaskIndex' id='subTaskIndex"+ rand +"' style='width:30px' value='' class='blueborderText' /></td>";
         str +=" <td align='center'>";
          ...
          str +="  </select>";
       str +=" </td>";
      str +="    <td><input type='text' name='value("+ rand +").subTaskDesc' readonly='true' id='subTaskDesc"+ rand +"' style='width:100%' class='blueborderText'/></td>";
      str +="    <td align='center'><input type='button' id='bwj"+ rand +"' name='Submit2' value='选择问卷' class='btn_BS' onClick=\"document.getElementById('surveyNum').value ="+ rand +";parent.ShowIframe('选择问卷','<%=baseURL %>/vcitySurveyAction.do?action=showVcitySureyList&flag="+ rand +"',700,580)\"><input type='button' style='display:none' id='bdc"+ rand +"' class='btn_BS' name='Submit2' value='选择场景' onClick=\"parent.ShowIframe('选择场景','<%=baseURL%>/scene.do?option=doGetTree&flag="+ rand +"&isManual=false',300,400);\">";
     ...
     str += "<input type='hidden' id='subTaskURL"+ rand +"' name='value("+ rand +").subTaskURL'>";
      str +="    <input type='button' name='Submit22' value=' 删除 ' onclick='removeTaskChild("+ rand +");' class='btn_BS' /></td>";
       str +=" </tr>"; 
     //	return str; 
...
function survery(name,id){
   var surveyNum=document.getElementById("surveyNum").value;
   if(surveyNum!=""){
		document.getElementById("subTaskURL"+surveyNum).value ="http://www.esaying.cn/wingo/do-survey-dispense.action?investigationId="+id;
		document.getElementById("subTaskResId"+surveyNum).value = 0;
		document.getElementById("subTaskDesc"+surveyNum).value = name;     
...
function localSurvery(num,str){
	if( str!=null){
		...
		document.getElementById("subTaskURL"+num).value ="<%=baseURL%>/surveyTest.do?id="+strarray[0];
...
function getHostList(Nid,label,num){
	var parentid = Nid.toString().substring(0,3);
	var describe = "";
	if(parentid != Nid.toString()){
		if(parentid=='101') describe="电信营业厅--";
		if(parentid=='102') describe="移动营业厅--";
		if(parentid=='103') describe="联通营业厅--";
		if(parentid=='104') describe="数码电子商场1--";
		if(parentid=='105') describe="数码电子商场2--";
		if(parentid=='106') describe="生活住宅区1--";
		if(parentid=='107') describe="生活住宅区2--";
	}
	 document.getElementById("subTaskResId"+num).value= Nid;
	  document.getElementById("value("+num+").subTaskDesc").value= "前往："+describe+label;
   
 	parent.ClosePop();
}

/*
function chooseModel(str){
	if( str!=null){
			...
			for(var i=0;i<strarray.length;i++){
				...
				if(va!=1){
					    	...
					    	str += "<td align='center' bgcolor='#EAF8FD'><input type='button' name='Submit' value='查看'>";
...
function chooseModel(id,name){
	
		var str =" <tr id='mo"+ id +"' >";
   		str +=" <td height='30' align='center' bgcolor='#EAF8FD'><input type='checkbox' checked name='modelId' value='"+ id +"'></td>";
   		str +=" <td bgcolor='#EAF8FD'><input type='hidden'  name='modelName' value='"+ name +"'><p>"+ name +"</p></td>";

    	str += "<td align='center' bgcolor='#EAF8FD'>";
    //	str += "<input type='button' name='Submit' value='查看' onClick=\"parent.ShowIframe('用户行为','<%=baseURL%>/vcityResourceAction.do?action=previewResource&resid="+ id +"',700,500)\">";
   		 str += " <input type='button' name='Submit2' value='删除' onclick='removeModel("+ id +");'></td>";
    	str += "</tr>";
