...
<script type="text/javascript">
		...
		var percent = ips[i];
			pieData[i] =  new Array(provinces[i],percent);
		}
...
<body>
<html:form  action="statisticsAction.do?action=showIPTotal"  >
...
<fieldset style="height:100%; padding:10px;">
      <legend><strong class="greenFont14">IP统计分析</strong></legend>
      <br>
