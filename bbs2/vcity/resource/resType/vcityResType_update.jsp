...
<body>
	<html:form action="/vcityResTypeAction.do?action=updateVcityResType" styleId="vcityResTypeForm">
	<html:hidden property="id" name="vcityResTypeForm"/>
				...
				<td >
					<table width="95%" height="93%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td>
								<html:text property="resType" name="vcityResTypeForm" value="${vcityResTypeForm.resType }"
						...
						<tr>
							<td height="30" class="tdr_B">
								<strong>备注：</strong>							</td>
							<td>
								<html:textarea property="resRemark" name="vcityResTypeForm" value="${vcityResTypeForm.resRemark }" styleClass="blueborderText" style="width:200px"/>							</td>
						</tr>
						<tr>
