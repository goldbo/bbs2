...
public class Action {
     ...
     * @param request The servlet request we are processing
     * @param reset Should we reset the token after checking it?
     * @param tokenName The user defines tokenName
     * @author zmw zhmu11@126.com
     */
    protected boolean isTokenValid(HttpServletRequest request, boolean reset, String tokenName) {

        return token.isTokenValid(request, reset, tokenName);
    ...
    protected void resetToken(HttpServletRequest request, String tokenName) {
        ...
        token.resetToken(request, tokenName);
    ...
    protected void saveToken(HttpServletRequest request, String tokenName) {
        token.saveToken(request, tokenName);
    }
