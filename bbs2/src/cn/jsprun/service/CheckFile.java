...
public class CheckFile {
	...
	public static void main(String[] args) {
		...
		Map<String,String> list = cf.checkFile("C:/Program Files/Apache Software Foundation/Tomcat 6.0/webapps/jsprunutf8/",new TreeMap<String,String>());
		cf.writejsprunFile("D:\\jsprunfiles.md5",list);
	}
}
