...
public class SystemToolAction extends BaseAction {
	...
	public ActionForward digestsubmit(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) {
		String digestsubmit = request.getParameter("digestsubmit");
		if(digestsubmit==null){
		...
		if (processed != 0) {
			...
			current = pers;
			request.setAttribute("url_forward", "admincp.jsp?action=counter&digest=yes&digestsubmit=yes&pertask=" + pertask+ "&current=" + current);
			return mapping.findForward("message");
		} else {
	...
	public ActionForward membersubmit(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) {
		String membersubmit = request.getParameter("membersubmit");
		if(membersubmit==null){
			Common.requestforward(response, "admincp.jsp?action=counter");
			return null;
		}
		String pertasks = request.getParameter("pertask");
		...
		if (processed != 0) {
			...
			current = pers;
			request.setAttribute("url_forward", "admincp.jsp?action=counter&member=yes&membersubmit=yes&pertask=" + pertask+ "&current=" + current);
			return mapping.findForward("message");
		} else {
	...
	public ActionForward threadsubmit(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) {
		String threadsubmit = request.getParameter("threadsubmit");
		if(threadsubmit==null){
			Common.requestforward(response, "admincp.jsp?action=counter");
			return null;
		}
		String pertasks = request.getParameter("pertask");
		...
		if (processed != 0) {
			...
			current = pers;
			request.setAttribute("url_forward", "admincp.jsp?action=counter&thread=yes&threadsubmit=yes&pertask=" + pertask + "&current=" + current);
			return mapping.findForward("message");
		} else {
	...
	public ActionForward movedthreadsubmit(ActionMapping mapping,
		...
		String movedthreadsubmit = request.getParameter("movedthreadsubmit");
		if(movedthreadsubmit==null){
			Common.requestforward(response, "admincp.jsp?action=counter");
			return null;
		}
		String pertasks = request.getParameter("pertask");
	...
	public ActionForward cleanupsubmit(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) {
		String cleanupsubmit = request.getParameter("cleanupsubmit");
		if(cleanupsubmit==null){
			Common.requestforward(response, "admincp.jsp?action=counter");
			return null;
		}
		String pertasks = request.getParameter("pertask");
		...
		if (processed != 0){
			...
			current = pers;
			request.setAttribute("url_forward", "admincp.jsp?action=counter&cleanup=yes&cleanupsubmit=yes&pertask=" + pertask+ "&current=" + current);
			return mapping.findForward("message");
		}else{
	...
	public ActionForward forumsubmit(ActionMapping mapping, ActionForm form,
		...
		current = pers;
		request.setAttribute("url_forward", "admincp.jsp?action=counter&forum=yes&forumsubmit=yes&pertask=" + pertask+ "&current=" + current);
		return mapping.findForward("message");
		}else{
