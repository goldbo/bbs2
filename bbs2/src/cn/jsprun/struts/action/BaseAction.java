...
import cn.jsprun.foreg.service.CommentService;
...
import cn.jsprun.service.AnswerTemplateService;
import cn.jsprun.service.AppointmentService;
...
import cn.jsprun.service.FriendGroupsService;
import cn.jsprun.service.ImageService;
import cn.jsprun.service.ImagetypesService;
import cn.jsprun.service.MagiclogService;
import cn.jsprun.service.MeetingMemberService;
import cn.jsprun.service.MemberService;
import cn.jsprun.service.OnLineSetService;
import cn.jsprun.service.OtherSetService;
import cn.jsprun.service.PermListService;
import cn.jsprun.service.PostsService;
import cn.jsprun.service.PresentService;
import cn.jsprun.service.RecyclebinService;
import cn.jsprun.service.SceneService;
import cn.jsprun.service.ScenectOrderService;
import cn.jsprun.service.ScenectService;
import cn.jsprun.service.ScenetaskService;
import cn.jsprun.service.ScenetmService;
import cn.jsprun.service.SendGiftsService;
import cn.jsprun.service.SettingService;
import cn.jsprun.service.SmiliesService;
import cn.jsprun.service.SpaceService;
import cn.jsprun.service.SpecialService;
import cn.jsprun.service.StyleService;
import cn.jsprun.service.SystemToolService;
import cn.jsprun.service.TagsService;
import cn.jsprun.service.TaskListService;
import cn.jsprun.service.TaskMemberService;
import cn.jsprun.service.TaskService;
import cn.jsprun.service.TemplateService;
import cn.jsprun.service.ThemeTemplateService;
...
public class BaseAction extends DispatchAction {
	...
	protected PolloptionsService optionService = (PolloptionsService) BeanFactory.getBean("polloptionsService");
	...
	protected ForumfieldService forumfieldService = (ForumfieldService) BeanFactory.getBean("forumfieldService");
	...
	protected MemberMagicsService memberMagicsService = (MemberMagicsService) BeanFactory.getBean("memberMagicsService");
	protected UserGroupService userGroupService = (UserGroupService)BeanFactory.getBean("userGroupService");
	protected Member_Magics_Magiclog_MemberMagicsService MMMMService = (Member_Magics_Magiclog_MemberMagicsService)BeanFactory.getBean("member_Magics_Magiclog_MemberMagicsService");
	protected MagiclogService magiclogService = (MagiclogService)BeanFactory.getBean("magiclogServer");
	protected MagicMarketService magicMarketService = (MagicMarketService)BeanFactory.getBean("magicMarketService");
	...
	protected TopicAdminActionService topicAdminActionService = (TopicAdminActionService) BeanFactory.getBean("topicAdminActionService");
	...
	protected ThreadtypeService threadtypeService = (ThreadtypeService) BeanFactory.getBean("threadtypeService");
	protected TypemodelService typemodelService = (TypemodelService) BeanFactory.getBean("typemodelService");
	protected TypeoptionService typeoptionService = (TypeoptionService) BeanFactory.getBean("typeoptionService");
	...
	protected ImagetypesService imagetypesService = (ImagetypesService) BeanFactory.getBean("imagetypesService");
	protected SmiliesService smilieService = (SmiliesService) BeanFactory.getBean("smiliesService");
	protected SystemToolService systemToolServer = (SystemToolService) BeanFactory.getBean("systemToolServer");
	protected ThreadtypesService threadTypeServer = (ThreadtypesService) BeanFactory.getBean("threadtypesService");
	protected PmsService pmsServer = (PmsService) BeanFactory.getBean("pmsServer");
	protected CreditslogService creditslogServer = (CreditslogService) BeanFactory.getBean("creditslogServer");
	...
	protected AttachmentsService attachmentsService = (AttachmentsService) BeanFactory.getBean("attachments_postService");
	protected WordsService wordsService = (WordsService) BeanFactory.getBean("wordsService");
	protected AttachtypesService attachtypesService = (AttachtypesService) BeanFactory.getBean("attachtypesService");
	protected BbcodesService bbcodesService = (BbcodesService) BeanFactory.getBean("bbcodesService");
	protected RecyclebinService recyclebinService = (RecyclebinService) BeanFactory.getBean("recyclebinService");
	
	
	//新增的开始
	protected CommentService commentService=(CommentService)BeanFactory.getBean("commentService");
	protected AnswerTemplateService answerTemplateService=(AnswerTemplateService)BeanFactory.getBean("answertemplateService");
	protected SpecialService specialService=(SpecialService)BeanFactory.getBean("specialService");
	protected PermListService permlistService=(PermListService)BeanFactory.getBean("permlistService");
	protected ImageService imageService=(ImageService)BeanFactory.getBean("imageService");
	protected ThemeTemplateService themeTemplateService=(ThemeTemplateService)BeanFactory.getBean("themeTemplateService");
	protected FriendGroupsService friendGroupsService=(FriendGroupsService)BeanFactory.getBean("firendGroupsService");
	protected PresentService presentService=(PresentService)BeanFactory.getBean("presentService");
	protected SendGiftsService sendGiftsService=(SendGiftsService)BeanFactory.getBean("sendGiftsService");
	protected TaskService taskService=(TaskService)BeanFactory.getBean("taskService");
	protected TaskListService taskListService=(TaskListService)BeanFactory.getBean("taskListService");
	protected TaskMemberService taskMemberService=(TaskMemberService)BeanFactory.getBean("taskMemberService");
	protected ScenetmService scenetmService=(ScenetmService)BeanFactory.getBean("scenetmService");
	protected ScenetaskService scenetaskService=(ScenetaskService)BeanFactory.getBean("scenetaskService");
	protected SceneService sceneService=(SceneService)BeanFactory.getBean("sceneService");
	protected ScenectService scenectService=(ScenectService)BeanFactory.getBean("scenectService");
	protected ScenectOrderService scenectOrderService=(ScenectOrderService)BeanFactory.getBean("scenectOrderService");

	/**********会议模块************/
	protected AppointmentService appointmentService =(AppointmentService)BeanFactory.getBean("appointmentService");
	protected MeetingMemberService meetingMemberService =(MeetingMemberService)BeanFactory.getBean("meetingMemberService");	
	//新增的结束
	...
	public void exportData(HttpServletRequest request, HttpServletResponse response, String fileName,String type, Map data){
		...
		exportContent.append("# Version: JspRun!_" + JspRunConfig.VERSION+"_"+ JspRunConfig.CHARSET+"\n");
