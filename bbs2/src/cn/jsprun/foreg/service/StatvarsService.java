...
public class StatvarsService {
	...
	public Stats_manageStatisticVO getFinalStats_manageStatisticVO(String beforeIR,String uidFromRequest,MessageResources mr,Locale locale){
		...
		if(uidFromRequest.equals("")){
			...
			List<Map<String,String>> list_modwords = dataBaseDao.executeQuery("SELECT uid, modaction, dateline, count, posts FROM "+tableprefix+"modworks WHERE uid='"+uidFromRequest+"' AND dateline>='"+startTime+"' AND dateline<'"+endTime+"'");
