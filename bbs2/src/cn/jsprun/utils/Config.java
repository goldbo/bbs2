...
public final class Config {
	...
	public static void main(String[] args) {
		Config d=new Config("d://config.properties");
		System.out.println(d.getValue("dbhost"));
		d.setValue("dbhost", "192.168");
		d.setValue("uchost", "192.168");
		d.setValue("ucuser", "admin");
		d.saveProperties(null);
		System.out.println(d.getValue("dbhost"));
