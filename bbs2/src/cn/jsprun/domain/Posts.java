...
public class Posts  implements java.io.Serializable {
    ...
    public Posts(Short fid, Integer tid, Byte first, String author, Integer authorid, String subject, Integer dateline, String message, String useip, Byte invisible, Byte anonymous, Byte usesig, Byte htmlon, Byte bbcodeoff, Byte smileyoff, Byte parseurloff, Byte attachment, Short rate, Short ratetimes, Byte status,String group) {
        this.fid = fid;
        this.tid = tid;
        this.first = first;
        this.author = author;
    ...
    public Posts(String author,String subject,Integer dateline,String message){
    	this.author=author;
    	this.subject=subject;
    	this.dateline=dateline;
    	this.message=message;
