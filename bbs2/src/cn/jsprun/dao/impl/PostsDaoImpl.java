...
public class PostsDaoImpl implements PostsDao {
	...
	public PostsPageForm fidnByForums(short fid,String displayorder) {
		...
		StringBuffer queryStr = new StringBuffer("select t.tid, t.fid, t.author, t.authorid, t.subject, t.dateline,p.pid, p.message, p.useip, p.attachment from jrun_threads t LEFT JOIN jrun_posts p ON p.tid=t.tid WHERE t.displayorder="+ displayorder);
		StringBuffer countStr = new StringBuffer("select count(*) from Threads as t where t.displayorder="+ displayorder);
		if (fid > 0) {
