...
import cn.vcity.wbase.common.helper.DispartPageDemoHTMLHelper;
import cn.vcity.wbase.common.helper.WebHelper;
import cn.vcity.wbase.common.vo.page.Pager;

public class DispartPageDemo extends BodyTagSupport {
	...
	public int doEndTag() throws JspException {
		...
		StringBuffer buf = DispartPageDemoHTMLHelper.getDispartPageHTML(pager, formId);
